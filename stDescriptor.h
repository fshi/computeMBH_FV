...
public:
	...
	bool preProcessing(const string& fName, int fms);
	bool re_Processing(const string& fName, int fms, int num);

	bool preProcessing(const string& fName, int st, int end);
